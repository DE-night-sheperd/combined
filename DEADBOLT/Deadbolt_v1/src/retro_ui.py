...
class DeadlockRetroUI:
    ...
    def admin_login(self):
        ...
        if self.admin_auth.authenticate(username, password):
            ...
            from usb_peripheral_key import TokenAuthenticator
    ...
    def show_admin_panel(self):
        ...
        def view_app_usage():
            usage_window = tk.Toplevel(admin_window)
            usage_window.title("Application Usage Statistics")
            usage_window.geometry("700x600")
            usage_window.configure(bg=WIN95_BG)
        ...
        buttons = [
            ("View System Activity Log", view_activity_log),
            ("View App Usage Stats", view_app_usage),
        ...
        admin_window.geometry("700x1000")
